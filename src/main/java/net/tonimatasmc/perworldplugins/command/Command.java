            ...
            if (args.length == 1) {
                ...
                if (args[0].equalsIgnoreCase("version")) {
                    if (sender.hasPermission("perworldplugins.version")) {
                        sender.sendMessage(ChatColor.WHITE + "[" + ChatColor.DARK_GREEN + "+" + ChatColor.WHITE + "] PerWorldPlugins: " + ChatColor.WHITE + "The version is: " + PerWorldPlugins.getPlugin().getDescription().getVersion());
                    }
                }
            } else {
